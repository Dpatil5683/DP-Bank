...
<body>
  ...
  <div id="title">
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark ">
      <a id="navbar-brand" href="index.php">DP<span>  Bank</span></a>
 ...
 <?php  
 echo '<h1 class="intro"><center>Our Customer Details</center></h1>';
...
?><br>
  <form action="select.php" method="POST" style="text-align:center">
    <label class="choose">Make a Transation </label>
...
<footer id="footer">
  ...
  <p>© Copyright 2022  DP Bank</p>
  <p>Made by dipali patil</p>
</footer>
